...
// and then display the word "three" on one line. The function two() display the word "two" on one 
// line. The main() function should display the phrase "starting now": before calling one_three() 
