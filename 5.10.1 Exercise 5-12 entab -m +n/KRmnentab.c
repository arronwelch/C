...
/**
 * The framework for this solution is the entab program in Kernighan & Plauger,
 * Software Tools(Addision-Wesley,1976).
 * This solution is similar to the entab program in Exercise 5-11.
*/